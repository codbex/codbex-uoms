...
var dao = require("codbex-uoms/gen/dao/Units-of-Measures/Dimension");
var http = require("codbex-uoms/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-uoms/gen/api/Dimension.js/" + entity.Id);
