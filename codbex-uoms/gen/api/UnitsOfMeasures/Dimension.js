...
const dao = require("codbex-uoms/gen/dao/UnitsOfMeasures/Dimension");
const http = require("codbex-uoms/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-uoms/gen/api/Dimension.js/" + entity.Id);
