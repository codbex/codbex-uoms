...
const validationModules = await Extensions.loadExtensionModules("codbex-uoms-Dimensions-Dimension", ["validate"]);

@Controller
class DimensionService {

    private readonly repository = new DimensionRepository();
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-uoms/gen/codbex-uoms/api/Dimensions/DimensionService.ts/" + entity.Id);
