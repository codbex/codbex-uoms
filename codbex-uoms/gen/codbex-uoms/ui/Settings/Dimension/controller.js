angular.module('page', ['blimpKit', 'platformView', 'platformLocale', 'EntityService'])
	.config(['EntityServiceProvider', (EntityServiceProvider) => {
		EntityServiceProvider.baseUrl = '/services/ts/codbex-uoms/gen/codbex-uoms/api/Settings/DimensionController.ts';
	}])
	.controller('PageController', ($scope, EntityService, Extensions, LocaleService, ButtonStates) => {
		...
		let translated = {
			yes: 'Yes',
			no: 'No',
			deleteConfirm: 'Are you sure you want to delete Dimension? This action cannot be undone.',
			deleteTitle: 'Delete Dimension?'
		};
		...
		LocaleService.onInit(() => {
			...
			translated.deleteTitle = LocaleService.t('codbex-uoms:codbex-uoms-model.defaults.deleteTitle', { name: '$t(codbex-uoms:codbex-uoms-model.t.DIMENSION)' });
			translated.deleteConfirm = LocaleService.t('codbex-uoms:codbex-uoms-model.messages.deleteConfirm', { name: '$t(codbex-uoms:codbex-uoms-model.t.DIMENSION)' });
		});
			...
			EntityService.count(filter).then((resp) => {
				...
				request.then((response) => {
					...
					Dialogs.showAlert({
						...
						message: LocaleService.t('codbex-uoms:codbex-uoms-model.messages.error.unableToLF', { name: '$t(codbex-uoms:codbex-uoms-model.t.DIMENSION)', message: message }),
				...
				Dialogs.showAlert({
					title: LocaleService.t('codbex-uoms:codbex-uoms-model.t.DIMENSION'),
					message: LocaleService.t('codbex-uoms:codbex-uoms-model.messages.error.unableToCount', { name: '$t(codbex-uoms:codbex-uoms-model.t.DIMENSION)', message: message }),
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
			...
			Dialogs.showDialog({
				...
				if (buttonId === 'delete-btn-yes') {
					EntityService.delete(id).then((response) => {
						...
						Dialogs.showAlert({
							title: LocaleService.t('codbex-uoms:codbex-uoms-model.t.DIMENSION'),
							message: LocaleService.t('codbex-uoms:codbex-uoms-model.messages.error.unableToDelete', { name: '$t(codbex-uoms:codbex-uoms-model.t.DIMENSION)', message: message }),
							type: AlertTypes.Error
						});
						console.error('EntityService:', error);
					});
