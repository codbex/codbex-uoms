...
var dao = require("codbex-uoms/data/dao/Units-of-Measures/Dimension");
var http = require("codbex-uoms/api/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-uoms/api/Dimension.js/" + entity.Id);
