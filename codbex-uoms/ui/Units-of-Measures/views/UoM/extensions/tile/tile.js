...
var dao = require("codbex-uoms/data/dao/Units-of-Measures/UoM.js")
...
exports.getTile = function(relativePath) {
	...
	try {
		...
		console.error("Error occured while involking 'codbex-uoms/data/dao/Units-of-Measures/UoM.customDataCount()': " + e);
	}
	return {
